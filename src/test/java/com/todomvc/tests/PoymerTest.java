...
public class PoymerTest extends TestBase{
    ...
    public void test1()  {
        ...
        Assert.assertTrue(polymerPage.createdItemElement(toDoItemOne).isDisplayed(),"My" +
                " First TODO item NOT created");
        Assert.assertTrue(polymerPage.createdItemElement(toDoItemTwo).isDisplayed(),"My " +
                "Second TODO item NOT created");
        ...
        Assert.assertTrue(polymerPage.createdItemElement(changedItem).isDisplayed(),"My " +
                "second item NOT changed");
